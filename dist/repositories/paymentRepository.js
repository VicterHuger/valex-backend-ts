...
function insert(paymentData) {
    return __awaiter(this, void 0, void 0, function () {
        var cardId, businessId, amount, rowCount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cardId = paymentData.cardId, businessId = paymentData.businessId, amount = paymentData.amount;
                    return [4 /*yield*/, database_1.connection.query("INSERT INTO payments (\"cardId\", \"businessId\", amount) VALUES ($1, $2, $3)", [cardId, businessId, amount])];
                case 1:
